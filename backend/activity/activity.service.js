...
var ActivityService = function () {
    ...
    var ActivityService = _classThis = /** @class */ (function () {
        function ActivityService_1(activityRepository) {
            this.activityRepository = activityRepository;
        }
        ActivityService_1.prototype.create = function (createActivityDto) {
            var activity = this.activityRepository.create({
        ...
        ActivityService_1.prototype.findAll = function () {
            return this.activityRepository.find();
        };
        ActivityService_1.prototype.findOne = function (id) {
            return this.activityRepository.findOneBy({ id: id });
        };
        ActivityService_1.prototype.update = function (id, updateActivityDto) {
